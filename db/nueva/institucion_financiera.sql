...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-01-2021 a las 19:12:41
...
(12, 6, 11, 11, 'Software de control de ventas', 'Para llevar el control de ventas, generacion de facturas', 'Nuevo', '19803.30', '2010-01-16', 10, 1);
...
(23, 11, '10', 11.00, 2021, 'Pasivo corriente'),
(24, 11, '1000', 111.00, 2021, 'Activo corriente'),
(25, 9, 'Caja', 15000.00, 2021, 'Activo corriente'),
(26, 9, 'Cuentas por pagar', 5000.00, 2021, 'Pasivo corriente');
...
(9, 'JUR00001', 47, 'BIC S.A DE C.V', '7a avenida jerusale, san salvador, el salvador', '7458-8956', NULL),
...
(19, 'CNA00001', 46, 'SHERWIN WILLIANS', NULL, 'Natural'),
(20, 'FIA00001', 48, 'san vicente, san vicente', NULL, 'Fiador'),
(21, 'CNA00020', 51, 'Farmacias economicas', NULL, 'Natural'),
(22, 'CNA00020', 52, 'DIANA S.A DE C.V', NULL, 'Natural'),
(23, 'FIA00021', 55, '5ta avenida norte, soyapango, san salvador, el salvador', NULL, 'Fiador'),
(24, 'FIA00021', 56, 'tecoluca, san vicente', NULL, 'Fiador');
...
--
-- Volcado de datos para la tabla `detallefiador`
--

INSERT INTO `detallefiador` (`id`, `idprestamo`, `idfiador`) VALUES
(1, 1, 20),
(2, 2, 23);
...
(156, 19, NULL, 'Remesas familiares', 1500.00, 'Ingreso'),
(157, 19, NULL, 'Micro empresa', 5000.00, 'Ingreso'),
(158, NULL, 20, 'Remesas', 1500.00, 'Ingreso'),
(159, NULL, 20, 'Pago de colegiatura', 2500.00, 'Egreso'),
(160, 19, NULL, 'Pago de luz y agua', 200.00, 'Egreso'),
(161, 19, NULL, 'Pago de colegiatura', 1500.00, 'Egreso'),
(162, NULL, 20, 'Alquiler casa', 300.00, 'Ingreso'),
(163, NULL, 24, 'Remesas', 1500.00, 'Ingreso');
...
(48, '74589548-8', 'Ashly Tatiana', 'Sanchez Diaz', 'Femenino', '7485-8965', 'san vicente, san vicente, el salvador', 'Soltero/a', '1998-01-14', 'Fiador'),
...
(55, '74859845-9', 'Jose Heriberto', 'Perez Bonificacio', 'Femenino', '7485-8956', 'cojutepeque, cuscatlan', 'Divorciado/a', '1998-01-20', 'Fiador'),
(56, '74581236-8', 'Kevin Alexis', 'Jimenez Ruiz', 'Femenino', '7485-4512', 'Tecoluca, san vicente', 'Soltero/a', '2000-01-27', 'Fiador');
...
INSERT INTO `prestamo` (`id`, `idcliente`, `idtipoprestamo`, `fecha`, `monto`, `numcuotas`, `estado`) VALUES
(1, 46, 17, '2021-01-20', 800.00, 20, 1),
(2, 51, 16, '2021-01-20', 1000.00, 25, 1),
(3, 47, 17, '2021-01-20', 10000.00, 50, 1);
