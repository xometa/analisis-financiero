<%-- 
    Document   : fiador
    Created on : Dec 29, 2020, 9:08:42 AM
    Author     : jsaul
--%>
...
<html lang="es">
    ...
    <body class="loading"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Fiadores</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-12 pb-2">
                                                <button type="button" class="btn btn-success font-weight-bold btn-rounded" id="btn-addfiador"><i class="mdi mdi-plus"></i> Nuevo fiador</button>
                                            </div>
                                            <h4 class="header-title col-md-12 mt-2 mb-2">Listado de fiadores</h4>
                                            <div class="col-lg-3">
                                                <div class="row">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header modal-colored-header bg-dark">
                        <h4 class="modal-title" id="tittle-modal">Nuevo Fiador</h4>
        ...
        <script src="assets/js/fiador/fiador.js"></script>
