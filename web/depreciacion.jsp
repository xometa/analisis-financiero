<%-- 
    ...
    Created on : Jan 14, 2021, 1:54:31 PM
    Author     : jsaul
--%>
...
<html lang="es">
    ...
    <body class="loading"
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Depreciacion de Activo Fijo</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <h4 class="header-title col-md-12 mt-2 mb-2">Listado de activos fijos (tangibles)</h4>
                                            <div class="col-lg-3">
                                                <div class="row">
                        ...
                        <div class="row" id="depreciacion-activofijo">
        ...
        <template id="vacio">
            <div class="col-lg-12">
                <div class="alert-info py-3 text-center rounded">
                    Seleccione un <strong>activo fijo</strong> de la tabla anterior, para visualizar la <strong>depreciación</strong> respectiva hasta el día de ahora.
                </div>
            </div>
        </template>
        ...
        <script src="assets/js/activofijo/depreciacion.js"></script>
