<%-- 
    Document   : tipoprestamo
    Created on : Jan 6, 2021, 12:48:56 PM
    Author     : jsaul
--%>
...
<html lang="es">
    ...
    <body class="loading"
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Tipo de prestamo</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Tipo de prestamo</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-12 pb-2">
                                                <button type="button" class="btn btn-success font-weight-bold btn-rounded" id="btn-addtipoprestamo"><i class="mdi mdi-plus"></i> Nuevo tipo prestamo</button>
                                            </div>
                                            <h4 class="header-title col-md-12 mt-2 mb-2">Listado de tipos de prestamos</h4>
                                            <div class="col-lg-3">
                                                <div class="row">
                                            ...
                                            <div class="py-2 col-lg-12">
                                                <div class="row" id="listado-tipoprestamos">
        ...
        <div class="modal fade" id="modal-tipoprestamo" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header modal-colored-header bg-dark">
                        <h4 class="modal-title" id="titulo-modal">Nuevo Tipo de Prestamo</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <form id="formTipoPrestamo" name="formTipoPrestamo" method="POST" autocomplete="off">
        ...
        <script src="assets/js/tipoprestamo/tipoprestamo.js"></script>
