<%-- 
    Document   : sucursal
    Created on : ene 6, 2021, 8:24:00 p.m.
    Author     : Kevin
--%>
...
<html lang="es">
    ...
    <body class="loading"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Sucursal</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-12 pb-2">
                                                <button type="button" class="btn btn-success font-weight-bold btn-rounded" id="btn-addsucursal"><i class="mdi mdi-plus"></i> Nuevo sucursal</button>
                                            </div>
                                            <h4 class="header-title col-md-12 mt-2 mb-2">Listado de sucursales</h4>
                                            <div class="col-lg-3">
                                                <div class="row">
                                            ...
                                            <div class="py-2 col-lg-12">
                                                <div class="row" id="listado-sucursales">
        ...
        <div class="modal fade" id="modal-sucursal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header modal-colored-header bg-dark">
                        <h4 class="modal-title" id="tittle-modal">Nuevo sucursal</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <form id="formSucursal" name="formSucursal" method="POST" autocomplete="off">
        ...
        <!-- Alert Modal -->
        <div id="modalEliminarSucursal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <div class="text-center">
                            <i class="dripicons-trash h1 text-danger"></i>
                            <h4 class="mt-2" id="titulo-eliminar">Eliminar sucursal</h4>
        ...
        <div id="modal-clientes" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="fullWidthModalLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-client">
                <div class="modal-content">
                    <div class="modal-header modal-colored-header bg-dark">
                        <h4 class="modal-title" id="dark-header-modalLabel">Listado de clientes</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12 px-4">
                                <p class="alert-info py-2 px-2 rounded"><span class="font-weight-bold">Observaciones :</span> Al eliminar un cliente de esta cartera, automaticamente el cliente podra ser asignado a otra cartera de clientes.</p>
                            </div>
                            <div class="col-lg-12 scroll-shopping" data-simplebar>
        ...
        <script src="assets/js/sucursal/sucursal.js"></script>
