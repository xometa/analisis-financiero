<%-- 
    Document   : tipoactivo
    Created on : ene 6, 2021, 8:14:00 p.m.
    Author     : Kevin
--%>
...
<html lang="es">
    ...
    <body class="loading"
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Tipo Activo</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Tipo Activo</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-12 pb-2">
                                                <button type="button" class="btn btn-success font-weight-bold btn-rounded" id="btn-addtipo"><i class="mdi mdi-plus"></i> Nuevo tipo de activo</button>
                                            </div>
                                            <h4 class="header-title col-md-12 mt-2 mb-2">Listado de tipos de activos</h4>
                                            <div class="col-lg-3">
                                                <div class="row">
        ...
        <div class="modal fade" id="modal-tipo" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header modal-colored-header bg-dark">
                        <h4 class="modal-title" id="titulo-modal">Nuevo tipo de activo</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <form id="formTipo" name="formTipo" method="POST" autocomplete="off">
        ...
        <!-- Alert Modal -->
        <div id="modalEliminarTipo" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <script src="assets/js/tipoactivo/tipoactivo.js"></script>
