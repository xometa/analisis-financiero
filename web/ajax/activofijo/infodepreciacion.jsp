...
<%
    ...
    Operaciones dp = ma.obtenerDepreciacion(id, "Anual");
    if (dp != null) {
        ...
        <div class="card-body">
            <div class="dropdown card-widgets">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <!-- item-->
                    <a href="PDFD?idactivofijo=<%= dp.getActivofijo().getId()%>&opcion=Diaria" target="blank" class="dropdown-item"><i class="mdi mdi mdi-file-pdf-box mr-1 h4"></i>Imprimir</a>
                </div>
            </div>
            <!-- project title-->
            <h4 class="mt-0">
                <span class="text-title">Depreciación por día</span>
            </h4>
            <%if (dp.isProceso()) {%>
            ...
            <p class="mb-1">
                <span class="pr-2 text-nowrap mb-2 d-inline-block">
                    <b><i class="uil-dollar-sign"></i> Depreciación actual:</b> $ <%= f.format(dp.getAcumuladoDias().floatValue())%>
                </span>
            </p>
            <p class="mb-1">
                <span class="pr-2 text-nowrap mb-2 d-inline-block">
                    <b><i class="uil-dollar-sign"></i> Deducible:</b> $ <%= f.format(dp.getDeducibleDias().floatValue())%>
                </span>
            </p>
        </div> <!-- end card-body-->
    ...
    <div class="card d-block">
        <div class="card-body">
            <div class="dropdown card-widgets">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <!-- item-->
                    <a href="PDFD?idactivofijo=<%= dp.getActivofijo().getId()%>&opcion=Mensual" target="blank" class="dropdown-item"><i class="mdi mdi mdi-file-pdf-box mr-1 h4"></i>Imprimir</a>
                </div>
            </div>
            <!-- project title-->
            <h4 class="mt-0">
                <span class="text-title">Depreciación por mes</span>
            </h4>
            <%if (dp.isProceso()) {%>
            <div class="badge badge-success mb-3">En proceso</div>
            <%} else {%>
            ...
            <p class="mb-1">
                <span class="pr-2 text-nowrap mb-2 d-inline-block">
                    <b><i class="uil-dollar-sign"></i> Depreciación actual:</b> $ <%= f.format(dp.getAcumuladoMeses().floatValue())%>
                </span>
            </p>
            <p class="mb-1">
                <span class="pr-2 text-nowrap mb-2 d-inline-block">
                    <b><i class="uil-dollar-sign"></i> Deducible:</b> $ <%= f.format(dp.getDeducibleMeses().floatValue())%>
                </span>
            </p>
        </div> <!-- end card-body-->
        <ul class="list-group list-group-flush">
    ...
    <div class="card d-block">
        <div class="card-body">
            <div class="dropdown card-widgets">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <!-- item-->
                    <a href="PDFD?idactivofijo=<%= dp.getActivofijo().getId()%>&opcion=Anual" target="blank" class="dropdown-item"><i class="mdi mdi mdi-file-pdf-box mr-1 h4"></i>Imprimir</a>
                </div>
            </div>
            <!-- project title-->
            <h4 class="mt-0">
                <span class="text-title">Depreciación por año</span>
            </h4>
            <%if (dp.isProceso()) {%>
            <div class="badge badge-success mb-3">En proceso</div>
            <%} else {%>
            ...
            <p class="mb-1">
                <span class="pr-2 text-nowrap mb-2 d-inline-block">
                    <b><i class="uil-dollar-sign"></i> Depreciación actual:</b> $ <%= f.format(dp.getAcumuladoYears().floatValue())%>
                </span>
            </p>
            <p class="mb-1">
                <span class="pr-2 text-nowrap mb-2 d-inline-block">
                    <b><i class="uil-dollar-sign"></i> Deducible:</b> $ <%= f.format(dp.getDeducibleYear().floatValue())%>
                </span>
            </p>
        </div> <!-- end card-body-->
        <ul class="list-group list-group-flush">
...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <h4 class="header-title mb-3">Depreciación anual</h4>
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>$ <%= f.format(a.getdDeduciblePeriodo().floatValue())%></td>
                        </tr>
                        <%}%>
                    </tbody>
                </table>
            ...
            <div class="row pt-2 float-right">
                <a href="PDFD?idactivofijo=<%= dp.getActivofijo().getId()%>&opcion=Anual" class="btn btn-primary btn-rounded" target="blank">Imprimir</a>
            </div>
        </div>
    </div>
