 ...
 * @author Kevin
 */
public class PDFCN extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            response.setHeader("Content-Disposition", "inline; filename=Clientes naturales");
            ...
            par1 = new Paragraph(new Phrase("REPORTE DE CLIENTES NATURALES", fonttitulo));
            par1.setAlignment(Element.ALIGN_CENTER);
            par1.add(new Phrase(Chunk.NEWLINE));//salto de linea
            par1.add(new Phrase(Chunk.NEWLINE));//salto de linea
            par1.add(new Phrase(Chunk.NEWLINE));//salto de linea
            ...
            Logger.getLogger(PDFCN.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
