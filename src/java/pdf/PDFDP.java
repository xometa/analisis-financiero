 ...
 * @author Kevin
 */
public class PDFDP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            response.setHeader("Content-Disposition", "inline; filename=Departamentos");
            ...
            par1 = new Paragraph(new Phrase("REPORTE DE DEPARTAMENTOS", fonttitulo));
            par1.setAlignment(Element.ALIGN_CENTER);
            par1.add(new Phrase(Chunk.NEWLINE));//salto de linea
            par1.add(new Phrase(Chunk.NEWLINE));//salto de linea
            par1.add(new Phrase(Chunk.NEWLINE));//salto de linea
            ...
            //emcabezado
            cell = new PdfPCell(new Paragraph("TABLA DE INFORMACIÓN SOBRE LOS DEPARTAMENTOS", FontFactory.getFont("courier", 12, Font.BOLD, BaseColor.BLACK)));
            ...
            for (Departamento d : dp) {
                cell = new PdfPCell(new Paragraph(d.getCodigo(), FontFactory.getFont("courier", 12, Font.NORMAL, BaseColor.BLACK)));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                cell.setRowspan(2);
                tabla.addCell(cell);
                
                cell = new PdfPCell(new Paragraph(d.getNombre(), FontFactory.getFont("courier", 12, Font.NORMAL, BaseColor.BLACK)));
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                cell.setRowspan(2);
                tabla.addCell(cell);
            }
            ...
            Logger.getLogger(PDFDP.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
